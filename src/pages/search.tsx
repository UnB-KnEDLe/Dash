      ...
      <Flex direction="row" w="100%" my="6" maxWidth={1480} mx="auto" px="6">
        ...
        <Flex direction="column" w="100%">
            ...
            <Table variant="striped" colorScheme="blackAlpha">
              <Thead bgColor="pallete.darkPrimary">
                <Tr>
                  <Th fontWeight="bold" color="pallete.background" px="4px" maxWidth="80px" pl="28px">SEI</Th>
                  <Th fontWeight="bold" color="pallete.background" px="4px" maxWidth="80px">Nome</Th>
              ...
              <Tbody fontWeight="500" bgColor="pallete.sidebarBackground">
                <Tr >
